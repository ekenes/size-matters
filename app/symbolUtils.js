...
define(["require", "exports", "esri/symbols/WebStyleSymbol", "esri/core/promiseUtils"], function (require, exports, WebStyleSymbol, promiseUtils) {
    "use strict";
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        response = _a.sent();
                        exports.symbolOptions.dottedArrows.above = response[0].value;
                        exports.symbolOptions.dottedArrows.below = response[1].value;
                        return [2 /*return*/];
                }
            });
        });
